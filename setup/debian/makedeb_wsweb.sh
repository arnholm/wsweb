...
# Run this script sudo and -E to preserve environment
#  sudo -E ./makedeb_wsweb.sh 
...
then
   ...
   ZIP_NAME="$PACKAGE_NAME"-"$WSWEB_VERSION"-"$DISTRO.zip"
   rm "$ZIP_NAME"
